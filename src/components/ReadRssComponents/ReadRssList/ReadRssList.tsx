            ...
            renderItem={({item, index}) => (
              <Pressable
                ...
                <View
                  ...
                  <Text style={[{color: appSettings.colors.text}, styles.rssListItemContent_title]}>{item.title}</Text>
              ...
              <>
                {rssData?.title && (
                  <View style={[styles.rssTopInfo, {borderColor: appSettings.colors.text}]}>
                    <Text numberOfLines={1} ellipsizeMode={'tail'} style={{color: appSettings.colors.text}}>
                      {rssData?.title}
                    </Text>
                    <Text
                      numberOfLines={1}
